...
/* harmony default export */ const store = (coreDataStore);
  ...
  function createRegistry(storeConfigs = {}, parent = null) {
    ...
    const subscribe = (listener, storeNameOrDescriptor) => {
      ...
      // See http://github.com/WordPress/gutenberg/pull/27466 for more info.
      if (!parent) {
        return emitter.subscribe(listener);
      }
...
/* harmony default export */ const persistence = (persistencePlugin);
   ...
   * http://react.dev/learn/passing-data-deeply-with-context#step-3-provide-the-context
   *
   * @example
   * ```js
   * import {
...
/* harmony default export */ const async_mode_provider_context = (context_Provider);
   ...
   * [rules of hooks](http://react.dev/reference/rules/rules-of-hooks).
   *
   * @template {MapSelect | StoreDescriptor<any>} T
