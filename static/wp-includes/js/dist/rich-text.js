...
/* harmony default export */ const reducer = ((0, external_wp_data_namespaceObject.combineReducers)({
   ...
   *
   * @see
   * http://developer.mozilla.org/en-US/docs/Web/CSS/white-space-collapse#collapsing_of_white_space
   *
  ...
  function applySelection({
    ...
    if (activeElement !== ownerDocument.activeElement) {
      ...
      // or `blur` property).
      //
      // See: http://github.com/Microsoft/TypeScript/issues/5901#issuecomment-431649653
   ...
   *
   * http://html.spec.whatwg.org/multipage/interaction.html#best-practices-for-in-page-editors
   *
   * @type {string}
   */
...
/* harmony default export */ const event_listeners_delete = (props => element => {
   ...
   *
   * @see http://www.w3.org/TR/input-events-2/#interface-InputEvent-Attributes
   *
   * @type {Set}
   */
...
/* harmony default export */ const selection_change_compat = (() => element => {
   ...
   * @see http://github.com/WordPress/gutenberg/pull/65857
   * @see http://github.com/WordPress/gutenberg/pull/66402
   */
