...
/* harmony default export */ const reducer = ((0, external_wp_data_namespaceObject.combineReducers)({
   ...
   *
   * @see http://github.com/WordPress/gutenberg/blob/HEAD/packages/data/README.md#registering-a-store
   *
   * @type {Object}
   */
  const storeConfig = {
  ...
  function getInserterOuterSection() {
    ...
    return class InserterOuterSection extends customize.OuterSection {
      constructor(...args) {
        ...
        // @See http://github.com/WordPress/wordpress-develop/blob/42b05c397c50d9dc244083eff52991413909d4bd/src/js/_enqueues/wp/customize/controls.js#L1427-L1436
