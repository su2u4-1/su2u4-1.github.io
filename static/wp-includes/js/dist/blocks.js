...
/***/ (function (module, exports, __webpack_require__) {
        ...
        (function () {
          ...
          var simpleURLRegex = /([*~_]+|\b)(((http?|ftp|dict):\/\/|www\.)[^'">\s]+?\.[^'">\s]+?)()(\1)?(?=\s|$)(?!["<>])/gi,
            simpleURLRegex2 = /([*~_]+|\b)(((http?|ftp|dict):\/\/|www\.)[^'">\s]+\.[^'">\s]+?)([.!?,()\[\]])?(\1)?(?=\s|$)(?!["<>])/gi,
            delimUrlRegex = /()<(((http?|ftp|dict):\/\/|www\.)[^'">\s]+)()>()/gi,
...
/* harmony default export */ function names(e, f) { var a = { white: "#ffffff", bisque: "#ffe4c4", blue: "#0000ff", cadetblue: "#5f9ea0", chartreuse: "#7fff00", chocolate: "#d2691e", coral: "#ff7f50", antiquewhite: "#faebd7", aqua: "#00ffff", azure: "#f0ffff", whitesmoke: "#f5f5f5", papayawhip: "#ffefd5", plum: "#dda0dd", blanchedalmond: "#ffebcd", black: "#000000", gold: "#ffd700", goldenrod: "#daa520", gainsboro: "#dcdcdc", cornsilk: "#fff8dc", cornflowerblue: "#6495ed", burlywood: "#deb887", aquamarine: "#7fffd4", beige: "#f5f5dc", crimson: "#dc143c", cyan: "#00ffff", darkblue: "#00008b", darkcyan: "#008b8b", darkgoldenrod: "#b8860b", darkkhaki: "#bdb76b", darkgray: "#a9a9a9", darkgreen: "#006400", darkgrey: "#a9a9a9", peachpuff: "#ffdab9", darkmagenta: "#8b008b", darkred: "#8b0000", darkorchid: "#9932cc", darkorange: "#ff8c00", darkslateblue: "#483d8b", gray: "#808080", darkslategray: "#2f4f4f", darkslategrey: "#2f4f4f", deeppink: "#ff1493", deepskyblue: "#00bfff", wheat: "#f5deb3", firebrick: "#b22222", floralwhite: "#fffaf0", ghostwhite: "#f8f8ff", darkviolet: "#9400d3", magenta: "#ff00ff", green: "#008000", dodgerblue: "#1e90ff", grey: "#808080", honeydew: "#f0fff0", hotpink: "#ff69b4", blueviolet: "#8a2be2", forestgreen: "#228b22", lawngreen: "#7cfc00", indianred: "#cd5c5c", indigo: "#4b0082", fuchsia: "#ff00ff", brown: "#a52a2a", maroon: "#800000", mediumblue: "#0000cd", lightcoral: "#f08080", darkturquoise: "#00ced1", lightcyan: "#e0ffff", ivory: "#fffff0", lightyellow: "#ffffe0", lightsalmon: "#ffa07a", lightseagreen: "#20b2aa", linen: "#faf0e6", mediumaquamarine: "#66cdaa", lemonchiffon: "#fffacd", lime: "#00ff00", khaki: "#f0e68c", mediumseagreen: "#3cb371", limegreen: "#32cd32", mediumspringgreen: "#00fa9a", lightskyblue: "#87cefa", lightblue: "#add8e6", midnightblue: "#191970", lightpink: "#ffb6c1", mistyrose: "#ffe4e1", moccasin: "#ffe4b5", mintcream: "#f5fffa", lightslategray: "#778899", lightslategrey: "#778899", navajowhite: "#ffdead", navy: "#000080", mediumvioletred: "#c71585", powderblue: "#b0e0e6", palegoldenrod: "#eee8aa", oldlace: "#fdf5e6", paleturquoise: "#afeeee", mediumturquoise: "#48d1cc", mediumorchid: "#ba55d3", rebeccapurple: "#663399", lightsteelblue: "#b0c4de", mediumslateblue: "#7b68ee", thistle: "#d8bfd8", tan: "#d2b48c", orchid: "#da70d6", mediumpurple: "#9370db", purple: "#800080", pink: "#ffc0cb", skyblue: "#87ceeb", springgreen: "#00ff7f", palegreen: "#98fb98", red: "#ff0000", yellow: "#ffff00", slateblue: "#6a5acd", lavenderblush: "#fff0f5", peru: "#cd853f", palevioletred: "#db7093", violet: "#ee82ee", teal: "#008080", slategray: "#708090", slategrey: "#708090", aliceblue: "#f0f8ff", darkseagreen: "#8fbc8f", darkolivegreen: "#556b2f", greenyellow: "#adff2f", seagreen: "#2e8b57", seashell: "#fff5ee", tomato: "#ff6347", silver: "#c0c0c0", sienna: "#a0522d", lavender: "#e6e6fa", lightgreen: "#90ee90", orange: "#ffa500", orangered: "#ff4500", steelblue: "#4682b4", royalblue: "#4169e1", turquoise: "#40e0d0", yellowgreen: "#9acd32", salmon: "#fa8072", saddlebrown: "#8b4513", sandybrown: "#f4a460", rosybrown: "#bc8f8f", darksalmon: "#e9967a", lightgoldenrodyellow: "#fafad2", snow: "#fffafa", lightgrey: "#d3d3d3", lightgray: "#d3d3d3", dimgray: "#696969", dimgrey: "#696969", olivedrab: "#6b8e23", olive: "#808000" }, r = {}; for (var d in a) r[a[d]] = d; var l = {}; e.prototype.toName = function (f) { if (!(this.rgba.a || this.rgba.r || this.rgba.g || this.rgba.b)) return "transparent"; var d, i, n = r[this.toHex()]; if (n) return n; if (null == f ? void 0 : f.closest) { var o = this.toRgb(), t = 1 / 0, b = "black"; if (!l.length) for (var c in a) l[c] = new e(a[c]).toRgb(); for (var g in a) { var u = (d = o, i = l[g], Math.pow(d.r - i.r, 2) + Math.pow(d.g - i.g, 2) + Math.pow(d.b - i.b, 2)); u < t && (t = u, b = g) } return b } }; f.string.push([function (f) { var r = f.toLowerCase(), d = "transparent" === r ? "#0000" : a[r]; return d ? new e(d).toRgb() : null }, "name"]) }
     ...
     *
     * @see http://developer.wordpress.org/resource/dashicons/
     */
     ...
     * [Create a block tutorial](http://developer.wordpress.org/block-editor/getting-started/create-block/).
     *
     ...
     * loaded. See http://developer.wordpress.org/block-editor/reference-guides/packages/packages-dom-ready/
     *
     * @param {string} name Block name.
     *
     * @example
     ...
     * [the official documentation](http://developer.wordpress.org/block-editor/reference-guides/block-api/block-styles/#styles).
     *
     ...
     * [the official documentation ](http://developer.wordpress.org/block-editor/reference-guides/block-api/block-variations/).
     *
...
/* harmony default export */ const reducer = ((0, external_wp_data_namespaceObject.combineReducers)({
    ...
    const processBlockType = (name, blockSettings) => ({
      ...
      if (!isValidIcon(settings.icon.src)) {
        true ? external_wp_warning_default()('The icon passed is invalid. ' + 'The icon should be a string, an element, a function, or an object following the specifications documented in http://developer.wordpress.org/block-editor/developers/block-api/block-registration/#icon-optional') : 0;
        return;
      }
      if (typeof settings?.parent === 'string' || settings?.parent instanceof String) {
        ...
        // that have been fixed by [#66250](http://github.com/WordPress/gutenberg/pull/66250).
        //
     ...
     *
     * @see http://github.com/WordPress/gutenberg/blob/HEAD/packages/data/README.md#createReduxStore
     *
     * @type {Object}
     */
...
/* harmony default export */ const esm_browser_v4 = (v4);
    ...
    function serializeAttributes(attributes) {
      return JSON.stringify(attributes)
        ...
        //
        // See: http://developer.wordpress.org/reference/functions/wp_kses_stripslashes/
        .replace(/\\"/g, '\\u0022');
    }
     ...
     *
     * See: http://html.spec.whatwg.org/multipage/common-microsyntaxes.html#boolean-attributes
     * Extracted from: http://html.spec.whatwg.org/multipage/indices.html#attributes-3
     *
     ...
     *
     * See: http://html.spec.whatwg.org/multipage/common-microsyntaxes.html#enumerated-attribute
     * Extracted from: http://html.spec.whatwg.org/multipage/indices.html#attributes-3
     *
     * Object.keys( Array.from( document.querySelectorAll( '#attributes-1 > tbody > tr' ) )
     ...
     * ```
     *
     * @see http://html.spec.whatwg.org/multipage/syntax.html#character-references
     * @see http://html.spec.whatwg.org/multipage/named-characters.html#named-character-references
     *
     * @type {RegExp}
     */
     ...
     *
     * @see http://github.com/tildeio/simple-html-tokenizer/tree/HEAD/src/entity-parser.ts
     */
    ...
    function getTextWithCollapsedWhitespace(text) {
      ...
      //
      // See: http://medium.com/@patrickbrosset/when-does-white-space-matter-in-html-b90e8a7cdd33
     ...
     *
     * @see http://dom.spec.whatwg.org/#interface-namednodemap
     *
 ...
 * source `node`.
 *
 * @see http://github.com/WordPress/gutenberg/pull/10439
 *
...
/* harmony default export */ const children = ({
    ...
    function parseRawBlock(rawBlock, options) {
      ...
      const parsedInnerBlocks = normalizedBlock.innerBlocks.map(innerBlock => parseRawBlock(innerBlock, options))
        // See http://github.com/WordPress/gutenberg/pull/17164.
     ...
     *
     * @see
     * http://developer.wordpress.org/block-editor/packages/packages-block-serialization-default-parser/
     *
    ...
    function segmentHTMLToShortcodeBlock(HTML, lastIndex = 0, excludedBlockNames = []) {
      ...
      if (match = (0, external_wp_shortcode_namespaceObject.next)(transformTag, HTML, lastIndex)) {
        ...
        if (typeof transformation.transform === 'function') {
          ...
          //
          // See: http://github.com/WordPress/gutenberg/pull/3610#discussion_r152546926
...
/* harmony default export */ const shortcode_converter = (segmentHTMLToShortcodeBlock);
    ...
    function msListConverter(node, doc) {
      ...
      if (!prevNode || !ms_list_converter_isList(prevNode)) {
        // See http://html.spec.whatwg.org/multipage/grouping-content.html#attr-ol-type.
     ...
     *
     * @see http://get.slack.help/hc/en-us/articles/202288908-how-can-i-add-formatting-to-my-messages-#code-blocks
     *
     ...
     *
     * @see http://www.w3.org/TR/css-text-3/#white-space-processing
     *
     * @param {Node} node The node to be processed.
     * @return {void}
     */
    function htmlFormattingRemover(node) {
      ...
      //
      // See: http://developer.mozilla.org/en-US/docs/Web/API/Node/parentElement#Browser_compatibility
    ...
    function pasteHandler({
      ...
      // See: http://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/normalize
      // See: http://core.trac.wordpress.org/ticket/30130
      // See: http://github.com/WordPress/gutenberg/pull/6983#pullrequestreview-125151075
