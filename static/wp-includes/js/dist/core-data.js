...
/* harmony default export */ const build_module_reducer = ((0, external_wp_data_namespaceObject.combineReducers)({
   ...
   * Inspired by _.set().
   *
   * @see http://lodash.com/docs/4.17.15#set
   *
  ...
  // See http://github.com/WordPress/gutenberg/pull/40025#discussion_r865410589 for more context.
   ...
   *                   include with request. For valid query parameters see the [Users page](http://developer.wordpress.org/rest-api/reference/users/) in the REST API Handbook and see the arguments for [List Users](http://developer.wordpress.org/rest-api/reference/users/#list-users) and [Retrieve a User](http://developer.wordpress.org/rest-api/reference/users/#retrieve-a-user).
   * @return Authors list.
   */
...
/* eslint-enable @typescript-eslint/no-unused-vars */);
   ...
   *
   * See http://github.com/WordPress/gutenberg/pull/41578 for more details.
   */
   ...
   *              fields, fields must always include the ID. For valid query parameters see the [Reference](http://developer.wordpress.org/rest-api/reference/) in the REST API Handbook and select the entity kind. Then see the arguments available "Retrieve a [Entity kind]".
   *
   * @return Record.
   */
   ...
   * @param kind  Entity kind.
   * @param name  Entity name.
   * @param query Optional terms query. For valid query parameters see the [Reference](http://developer.wordpress.org/rest-api/reference/) in the REST API Handbook and select the entity kind. Then see the arguments available for "List [Entity kind]s".
   *
   ...
   *
   * @see GetEntityRecord
   * @see http://github.com/WordPress/gutenberg/pull/41578
   */
   ...
   *              fields, fields must always include the ID. For valid query parameters see the [Reference](http://developer.wordpress.org/rest-api/reference/) in the REST API Handbook and select the entity kind. Then see the arguments available for "List [Entity kind]s".
   *
   * @return Records.
   */
   ...
   * `canUser()` resolver.
   *
   * http://developer.wordpress.org/rest-api/reference/
   *
   * @param state    Data state.
   ...
   * @param query     Optional query. If requesting specific
   *                  fields, fields must always include the ID. For valid query parameters see revisions schema in [the REST API Handbook](http://developer.wordpress.org/rest-api/reference/). Then see the arguments available "Retrieve a [Entity kind]".
   *
   * @return Record.
   */
...
/* harmony default export */ const forward_resolver = (forwardResolver);
  ...
  const fetchUrlData = async (url, options = {}) => {
    ...
    if (!protocol || !(0, external_wp_url_namespaceObject.isValidProtocol)(protocol) || !protocol.startsWith('http') || !/^http?:\/\/[^\/\s]/i.test(url)) {
  ...
  const resolvers_getEntityRecords = (kind, name, query = {}) => async ({
    ...
    try {
      ...
      registry.batch(() => {
        ...
        // See http://github.com/WordPress/gutenberg/pull/26575
        // See http://github.com/WordPress/gutenberg/pull/64504
...
/* harmony default export */ const use_resource_permissions = (useResourcePermissions);
  ...
  //
  // Fix once http://github.com/WordPress/gutenberg/issues/52692 is closed.
  let unlockedApis;
  const cache = new WeakMap();
